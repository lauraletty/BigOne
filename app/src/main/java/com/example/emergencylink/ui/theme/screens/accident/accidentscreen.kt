package com.example.emergencylink.ui.theme.screens.accident
...
@Composable
fun accidentscreen(navController: NavHostController){
    Column(
        modifier = Modifier
            .fillMaxSize()
        ...
        Image(painter = painterResource(id = R.drawable.accidentalert),
...
fun accidentscreenPreview(){
    accidentscreen(navController = rememberNavController())
