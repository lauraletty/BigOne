package com.example.emergencylink.ui.theme.screens.earhquake
...
@Composable
fun earthquackescreen(navController: NavHostController) {
    Column(
        modifier = Modifier
            .fillMaxSize()
        ...
        Image(
            painter = painterResource(id = R.drawable.eartquackealert),
...
fun earthquackescreenPreview(){
    earthquackescreen(navController = rememberNavController())
